            ...
            <div>
              ...
              <div style={{ marginTop: 32, display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                {isSkillsProgramme ? (
                  ...
                  <a
                    href={`mailto:applications@cps.co.za?subject=${encodeURIComponent(`Info pack: ${p.title}`)}`}
        ...
        <div className="container">
          <Spotlight as="div" className="pd-bottom-cta">
            ...
            <div className="actions">
              <a className="btn-yellow" href={`mailto:applications@cps.co.za?subject=${encodeURIComponent(mailSubject)}`}>{primaryCtaLabel}</a>
